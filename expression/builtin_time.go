...
func (c *dateFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDatetime, types.ETDatetime)
	if err != nil {
		return nil, err
	}
...
func (c *dateLiteralFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, []Expression{}, types.ETDatetime)
	if err != nil {
		return nil, err
	}
	bf.tp.Tp, bf.tp.Flen, bf.tp.Decimal = mysql.TypeDate, 10, 0
...
func (c *dateDiffFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETInt, types.ETDatetime, types.ETDatetime)
	if err != nil {
		return nil, err
	}
...
func (c *timeDiffFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDuration, arg0Tp, arg1Tp)
	if err != nil {
		return nil, err
	}
...
func (c *dateFormatFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETString, types.ETDatetime, types.ETString)
	if err != nil {
		return nil, err
	}
...
func (c *fromDaysFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDatetime, types.ETInt)
	if err != nil {
		return nil, err
	}
...
func (c *hourFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETInt, types.ETDuration)
	if err != nil {
		return nil, err
	}
...
func (c *monthFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETInt, types.ETDatetime)
	if err != nil {
		return nil, err
	}
	bf.tp.Flen, bf.tp.Decimal = 2, 0
...
func (c *monthNameFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETString, types.ETDatetime)
	if err != nil {
		return nil, err
	}
...
func (c *fromUnixTimeFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (sig builtinFunc, err error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, retTp, argTps...)
	if err != nil {
		return nil, err
	}
...
func (c *getFormatFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETString, types.ETString, types.ETString)
	if err != nil {
		return nil, err
	}
	bf.tp.Flen = 17
...
func (c *strToDateFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (sig builtinFunc, err error) {
	...
	switch retTp {
	case mysql.TypeDate:
		bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDatetime, types.ETString, types.ETString)
		if err != nil {
			return nil, err
		}
	...
	case mysql.TypeDuration:
		bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDuration, types.ETString, types.ETString)
		if err != nil {
			return nil, err
		}
		if fsp == types.MinFsp {
...
func (c *sysDateFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDatetime, argTps...)
	if err != nil {
		return nil, err
	}
...
func (c *currentDateFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDatetime)
	if err != nil {
		return nil, err
	}
	bf.tp.Flen, bf.tp.Decimal = 10, 0
...
func (c *currentTimeFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (sig builtinFunc, err error) {
	...
	if len(args) == 0 {
		bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDuration)
		if err != nil {
			return nil, err
		}
		bf.tp.Flen, bf.tp.Decimal = mysql.MaxDurationWidthNoFsp, int(types.MinFsp)
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDuration, types.ETInt)
	if err != nil {
		return nil, err
	}
...
func (c *timeFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDuration, types.ETString)
	if err != nil {
		return nil, err
	}
...
func (c *timeLiteralFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, []Expression{}, types.ETDuration)
	if err != nil {
		return nil, err
	}
...
func (c *extractFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (sig builtinFunc, err error) {
	...
	if isDatetimeUnit {
		bf, err = newBaseBuiltinFuncWithTp(ctx, args, types.ETInt, types.ETString, types.ETDatetime)
		if err != nil {
			return nil, err
		}
		...
		bf, err = newBaseBuiltinFuncWithTp(ctx, args, types.ETInt, types.ETString, types.ETDuration)
		if err != nil {
			return nil, err
		}
...
func (c *addDateFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (sig builtinFunc, err error) {
	...
	if dateEvalTp == types.ETDuration {
		...
		bf, err = newBaseBuiltinFuncWithTp(ctx, args, types.ETDuration, argTps...)
		if err != nil {
			return nil, err
		}
		arg0Dec, err := getExpressionFsp(ctx, args[0])
...
func (c *timestampDiffFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETInt, types.ETString, types.ETDatetime, types.ETDatetime)
	if err != nil {
		return nil, err
	}
...
func (c *timestampFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDatetime, evalTps...)
	if err != nil {
		return nil, err
	}
...
func getBf4TimeAddSub(ctx sessionctx.Context, args []Expression) (tp1, tp2 *types.FieldType, bf baseBuiltinFunc, err error) {
	...
	bf, err = newBaseBuiltinFuncWithTp(ctx, args, retTp, argTp1, argTp2)
	if err != nil {
		return
	}
...
func (c *convertTzFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDatetime, types.ETDatetime, types.ETString, types.ETString)
	if err != nil {
		return nil, err
	}
...
func (c *makeDateFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDatetime, types.ETInt, types.ETInt)
	if err != nil {
		return nil, err
	}
	tp := bf.tp
...
func (c *makeTimeFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDuration, arg0Type, arg1Type, types.ETReal)
	if err != nil {
		return nil, err
	}
...
func (c *periodAddFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETInt, types.ETInt, types.ETInt)
	if err != nil {
		return nil, err
	}
	bf.tp.Flen = 6
...
func (c *secToTimeFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETDuration, types.ETReal)
	if err != nil {
		return nil, err
	}
...
func (c *timeFormatFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETString, types.ETDuration, types.ETString)
	if err != nil {
		return nil, err
	}
	// worst case: formatMask=%r%r%r...%r, each %r takes 11 characters
...
func (c *timestampAddFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETString, types.ETString, types.ETInt, types.ETDatetime)
	if err != nil {
		return nil, err
	}
...
func (c *tidbParseTsoFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, argTp, types.ETInt)
	if err != nil {
		return nil, err
	}
