...
func (c *absFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, argTp, argTp)
	if err != nil {
		return nil, err
	}
...
func (c *roundFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, argTp, argTps...)
	if err != nil {
		return nil, err
	}
	argFieldTp := args[0].GetType()
...
func (c *ceilFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (sig builtinFunc, err error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, retTp, argTp)
	if err != nil {
		return nil, err
	}
...
func (c *logFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	if argsLen == 1 {
		bf, err = newBaseBuiltinFuncWithTp(ctx, args, types.ETReal, types.ETReal)
		if err != nil {
			return nil, err
		}
	} else {
		bf, err = newBaseBuiltinFuncWithTp(ctx, args, types.ETReal, types.ETReal, types.ETReal)
		if err != nil {
			return nil, err
		}
	}
...
func (c *randFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETReal, argTps...)
	if err != nil {
		return nil, err
	}
	bt := bf
...
func (c *convFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETString, types.ETString, types.ETInt, types.ETInt)
	if err != nil {
		return nil, err
	}
	bf.tp.Flen = 64
...
func (c *signFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, types.ETInt, types.ETReal)
	if err != nil {
		return nil, err
	}
...
func (c *piFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err = newBaseBuiltinFuncWithTp(ctx, args, types.ETReal)
	if err != nil {
		return nil, err
	}
	bf.tp.Decimal = 6
...
func (c *truncateFunctionClass) getFunction(ctx sessionctx.Context, args []Expression) (builtinFunc, error) {
	...
	bf, err := newBaseBuiltinFuncWithTp(ctx, args, argTp, argTp, types.ETInt)
	if err != nil {
		return nil, err
	}
