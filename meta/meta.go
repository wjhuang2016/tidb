...
// GetMaxSchemaVersion gets current global schema version.
func (m *Meta) GetMaxSchemaVersion() (int64, error) {
...
// GenSchemaVersions generates next schema version.
func (m *Meta) GenSchemaVersions(n int64) (int64, error) {
	return m.txn.Inc(mSchemaVersionKey, n)
}
...
type SchemaVersionAlloc struct {
	Mu   sync.Mutex
	Curr int64
	End  int64
}

var Sva SchemaVersionAlloc
